...
<form:form method="post" commandName="watchConfig">
  ...
  <div class="field">
    <div><label for="categories">Enabled Categories</label>
      <span class="note">Display logging events in following categories.</span>
    </div>
    <div class="checkboxes">
      <form:checkboxes id="categories" path="categoryIds"
