...
public class PasswordModifyResponse implements ExtendedResponse
{
  ...
  /** Generated password. */
  private Credential generatedPassword;
  ...
  /**
   * Creates a new password modify response.
   *
   * @param  genPass  desired password for the dn
   */
  public PasswordModifyResponse(final Credential genPass)
  {
  ...
  /**
   * Returns the generated password or null if no password was generated by this
   * operation.
   *
   * @return  generated password
   */
  public Credential getGeneratedPassword()
  {
   ...
   *
   * @param  password  generated by a password modify request
   */
  public void setGeneratedPassword(final Credential password)
  {
  ...
  private static class PasswordModifyResponseHandler implements ParseHandler
  {
    ...
    public void handle(final DERParser parser, final ByteBuffer encoded)
    {
      if (SEQ_PATH.equals(parser.getCurrentPath())) {
        ...
        if (tag == GEN_PASS) {
          modifyResponse.setGeneratedPassword(
