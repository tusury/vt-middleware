    ...
    return new Object[][] {
      ...
      new Object[] {
        LdapUtils.base64Decode(
          "MHQCAQACAQAEbE1TRFMDAAAAAmDMQ7HCzQEAAAAAAAAAACgAAABbzwEAAAAAAAAAAA" +
          "AAAAAAW88BAAAAAADzox7OKwdpRIu4ZIWpCoubAQAAAAAAAAABAAAAAAAAAPOjHs4r" +
          "B2lEi7hkhakKi5vyzwEAAAAAAA=="),
        new DirSyncControl(
          null,
          new byte[] {
      ...
      new Object[] {
        LdapUtils.base64Decode(
          "MHUCAggAAgFkBGxNU0RTAwAAAN2j6LS3ws0BAAAAAAAAAAAoAAAAW88BAAAAAAAAAA" +
          "AAAAAAAFvPAQAAAAAA86MezisHaUSLuGSFqQqLmwEAAAAAAAAAAQAAAAAAAADzox7O" +
          "KwdpRIu4ZIWpCoubCdABAAAAAAA="),
        new DirSyncControl(
          new DirSyncControl.Flag[] {DirSyncControl.Flag.ANCESTORS_FIRST_ORDER},
          new byte[] {
            (byte) 0x4D, (byte) 0x53, (byte) 0x44, (byte) 0x53, (byte) 0x03,
