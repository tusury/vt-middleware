...
public class PersistentSearchRequestControlTest
{
    ...
    return new Object[][] {
      ...
      new Object[] {
        ...
        new PersistentSearchRequestControl(
          EnumSet.allOf(PersistentSearchChangeType.class), true, true),
      },
      ...
      new Object[] {
        ...
        new PersistentSearchRequestControl(
          EnumSet.of(PersistentSearchChangeType.MODIFY), false, true),
      },
  ...
  public void encode(
    final byte[] berValue, final PersistentSearchRequestControl expected)
    throws Exception
  {
