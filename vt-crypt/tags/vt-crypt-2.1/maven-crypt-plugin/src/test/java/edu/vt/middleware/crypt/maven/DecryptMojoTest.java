...
public class DecryptMojoTest extends AbstractMojoTestCase
{
    ...
    throws Exception
  {
    ...
    final File pomFile1 = getTestFile(
      "src/test/resources/decrypt-project-property-test.xml");
    ...
    final File pomFile2 = getTestFile(
      "src/test/resources/decrypt-profile-property-test.xml");
    ...
    for (String property : expectedValueMap.keySet()) {
      ...
      final Profile profile = (Profile) mojo2.project.getModel().getProfiles()
          .get(0);
      assertEquals(
        expectedValueMap.get(property),
