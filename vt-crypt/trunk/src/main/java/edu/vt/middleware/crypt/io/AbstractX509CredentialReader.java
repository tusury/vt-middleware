 ...
 */
public abstract class AbstractX509CredentialReader<T> implements CredentialReader<T>
{
  /** Certificate type. */
   ...
   *
   * @throws  CryptException  On provider errors creating certificate factory of X.509 type.
   */
  protected CertificateFactory getX509CertificateFactory() throws CryptException
  {
    if (factory == null) {
