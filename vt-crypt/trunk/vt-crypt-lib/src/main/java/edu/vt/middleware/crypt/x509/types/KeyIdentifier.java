/*
  $Id: KeyIdentifier.java 427 2009-08-12 16:41:24Z marvin.addison $
...
public class KeyIdentifier
{
  ...
  /**
   * @return  Key identifier bytes as a hex fingerprint where each pair of
   * hex digits are separated by colons.
   */
  @Override
