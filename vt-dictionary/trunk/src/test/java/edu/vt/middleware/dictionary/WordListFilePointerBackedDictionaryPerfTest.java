 ...
 * @version  $Revision: 166 $
 */
public class WordListFilePointerBackedDictionaryPerfTest
  extends AbstractDictionaryPerfTest
{
    ...
    throws Exception
  {
    ...
    System.out.println(
      ...
      FilePointerWordList.class.getSimpleName() + ") time to construct: " +
      t + "ms");
  }
    ...
    throws Exception
  {
    ...
    System.out.println(
      this.wld.getClass().getSimpleName() + " (" +
      FilePointerWordList.class.getSimpleName() + ") search time: " +
      (this.wldSearchTime / 1000 / 1000) + "ms");
    System.out.println(
      this.wld.getClass().getSimpleName() + " (" +
      FilePointerWordList.class.getSimpleName() + ") avg time per search: " +
