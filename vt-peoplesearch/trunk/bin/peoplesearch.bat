...
set CLASSPATH=%LIBDIR%\aopalliance-1.0.jar;%LIBDIR%\commons-cli-1.2.jar;%LIBDIR%\commons-codec-1.3.jar;%LIBDIR%\commons-logging-1.1.1.jar;%LIBDIR%\dom4j-1.6.1.jar;%LIBDIR%\spring-beans-2.5.6.jar;%LIBDIR%\spring-context-2.5.6.jar;%LIBDIR%\spring-core-2.5.6.jar;%LIBDIR%\vt-ldap-3.1.jar;%LIBDIR%\vt-servlet-filters-2.0.1.jar;%PEOPLESEARCH_JAR%
